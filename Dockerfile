...
ENV HOMEASSISTANT_VERSION=${HOMEASSISTANT_VERSION:-"2025.1.1"} \
    ...
    GO2RTC_VERSION=${GO2RTC_VERSION:-"v1.9.8"} \
    GOLANG_VERSION=${GOLAND_VERSION:-"1.23.4"} \
